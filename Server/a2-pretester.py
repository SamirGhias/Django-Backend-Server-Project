...
class PreTest(unittest.TestCase):
    def setUp(self):
        ...
        data_register = {"username": "test_" + str(self.num), "password1": "iamatester", "password2": "iamatester",
                         "email": "me@utoronto.ca", "first_name": "Han Xian Xu", "last_name": "Huang"}
        ...
        # print('REGISTERED', res1_post.status_code)
        ...
        # print("login STATUS 302", res2_post.status_code)
        ...
        # print("Bank add STATUS 302", res5_post.status_code)
        # print("Bank add STATUS 302", res5_post.status_code)
        # print("HEADERS", res5_post.headers["Location"])
        ...
        #
        # print("HEADERS", res9_post.headers)
    ...
    def test_edit_profile(self):
        ...
        data_edit_profile = {"password1": "iamatester", "password2": "iamatester", "email": "me@utoronto.ca",
    ...
    def test_branch_details(self):
        ...
        res10 = requests.get(url_branch_details, cookies=self.cookies)
        self.assertEqual(200, res10.status_code)

    def test_edit_branch(self):
        url_edit_branch = "http://localhost:8000/banks/branch/" + self.branch_id + "/edit/"
        data_edit_branch = {"name": "Test", "transit_num": "12345", "address": "UTM", "email": "br@utoronto.ca",
                            "capacity": 10}
        res11_get = requests.get(url_edit_branch, cookies=self.cookies)
        res11_post = requests.post(url_edit_branch, data=data_edit_branch, cookies=self.cookies)
        self.assertEqual(200, res11_get.status_code)
        self.assertEqual(200, res11_post.status_code)
